...
sudo lxc-create -n $NAME -t download -- -d ubuntu -a amd64 -r bionic
...
sudo lxc-attach -n $NAME -- bash -c "/usr/bin/sudo -i -u gerald /bin/bash -c 'cd init-xenial-mahara;./bionic_setup.sh'"
